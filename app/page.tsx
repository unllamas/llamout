    ...
    <>
      <div className='relative z-10 min-w-screen min-h-dvh'>
        <div className='absolute top-0 z-0 flex justify-center gap-16 w-full h-full max-h-96'>
          <div className='w-1 h-full bg-linear-to-t from-transparent to-white'></div>
          <div className='w-1 h-full bg-linear-to-t from-transparent to-white'></div>
        </div>
        <div className='relative z-10 flex flex-col gap-8 md:gap-16'>
          ...
          <div className='relative z-10'>
            ...
            <div className='absolute z-10 bottom-0 w-full h-full bg-linear-to-t from-background via-5% via-background/100  to-background/0'></div>
          </div>
          <Plans id='pricing' />
          <FAQ id='faq' />
          <FinalCTA id='contact' />
